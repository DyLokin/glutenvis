...
with open("CS.GSYield (1).csv", "rb") as csvfile, open ("colours.txt", "wb") as coloursFile, open ("mappedglutens.txt", "wb") as mappedFile, open ("unmapped.txt", "wb") as unmappedFile:
...
#EXTRACTING DATA INTO VARIABLES:#
		...
		chromosomeID = row0[6]
		geneID = row[2]
		classID = row8[3].split("=")[1]
		subclassID = row8[4].split("=")[1]
#COMPARING:#
